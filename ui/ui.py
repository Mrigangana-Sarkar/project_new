...
FEVICON = THIS_DIRECTORY_RELATIVE / "favicon.ico"
AVATAR_BOT = THIS_DIRECTORY_RELATIVE / "ai_avatar.ico"

UI_TAB_TITLE = "Private LLM"
...
class PrivateGptUi:
    ...
    def _build_ui_blocks(self) -> gr.Blocks:
        ...
        with gr.Blocks(
            ...
            with gr.Row():
                    gr.HTML(f"""
                        <div style="display: flex; align-items: center; justify-content: center; height: 100px; background-color: #a9cbdb;">
                            <img src="{logo_svg}" alt="PrivateGPT" style="height: 80px;" />
                        </div>
                    """)
            ...
            with gr.Row(equal_height=False):
                with gr.Column(scale=3):
                    ...
                    upload_button = gr.components.UploadButton(
                        ...
                        type="filepath",
                        file_count="multiple",
                        file_types=[".pdf", ".docx", ".ppt", ".pptx", ".jpg", ".jpeg", ".png"],
                        size="sm",
                    )
    ...
    def mount_in_app(self, app: FastAPI, path: str) -> None:
        ...
        gr.mount_gradio_app(app, blocks, path=path, favicon_path= FEVICON)
